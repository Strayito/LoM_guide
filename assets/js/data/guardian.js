...
var GUARDIAN_STARS = {
  ...
  // ── Hero ──────────────────────────────────────────────────────────────────
  'Zeus':              [[1,6500,40000,'—'],[2,6825,42000,'—'],[3,7150,44000,'—'],[4,7475,46000,'—'],[5,7800,48000,'—']],
  'Goddess Of Wisdom': [[1,3000,60000,'—'],[2,3150,63000,'—'],[3,3300,66000,'—'],[4,3450,69000,'—'],[5,3600,72000,'—']],
  'Valkyrie':          [[1,3600,60000,'—'],[2,3780,63000,'—'],[3,3960,66000,'—'],[4,4140,69000,'—'],[5,4320,72000,'—']],
  'Hercules':          [[1,2300,80000,'—'],[2,2415,84000,'—'],[3,2530,88000,'—'],[4,2645,92000,'—'],[5,2760,96000,'—']],
};
